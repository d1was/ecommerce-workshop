        ...
        <div class="container mx-auto">
            <div class="flex justify-between items-center">
                ...
                <ul class="px-2 flex items-center">
                    ...
                    <li class="px-6 py-4"><a href="/cart/summary" class="text-md text-white inline-block px-6 py-2 border-2 border-white-600 rounded-sm hover:bg-white transition-all">Create an account</a></li>
                </ul>
            </div>
        </div>
    </nav>
